...
create_clock -period 1.00 -name ADC_CLK_P -waveform  {0.00 0.50} [get_ports ADC_CLK_P]
create_clock -period 1.00 -name DAC_CLK_P -waveform  {0.00 0.50} [get_ports DAC_CLK_P]
